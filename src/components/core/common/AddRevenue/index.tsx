...
interface AddRevenueProps extends ModalProps {
	t: any;
	clubId: string;
	setOpen: any;
	refetch: any;
...
function AddRevenue(props: AddRevenueProps) {
	...
	return (
		<S.UserModal {...props} title={t("modal.revenue")}>
			{contextHolder}
			<Form
				form={form}
				labelCol={{ span: 4 }}
			...
			>
				...
				<Form.Item name="type" style={{ display: "none" }} initialValue="r">
					<Input type="hidden" />
				</Form.Item>
